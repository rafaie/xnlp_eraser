...
@Model.register("model_2docs6")
class Model2Docs6(BaseModel):
    def __init__(
        self,
        vocab: Vocabulary,
        ...
        super(Model2Docs6, self).__init__(
    ...
    def forward(self, document, kept_tokens, rationale=None, label=None, metadata=None) -> Dict[str, Any]:
        ...
        embedded_text = self.cross_att(query_states=premise_text,
                                       attention_mask=premise_mask,
                                       source_states=query_text,
                                       source_attention_mask=query_mask)

        embedded_vec = self._feedforward_encoder(embedded_text.hidden_states.sum(1))
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        base_metrics = super(Model2Docs6, self).get_metrics(reset)

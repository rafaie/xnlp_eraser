...
@Model.register("simple_model_2docs")
class SimpleModel2Docs(BaseModel):
    def __init__(
        self,
        vocab: Vocabulary,
        ...
        super(SimpleModel2Docs, self).__init__(
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        base_metrics = super(SimpleModel2Docs, self).get_metrics(reset)

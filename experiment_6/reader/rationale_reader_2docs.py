...
class RationaleReader2Docs(DatasetReader):
    ...
    def text_to_instance(
        ...
        metadata = {
            ...
            "convert_tokens_to_instance_2docs": self.convert_tokens_to_instance_2docs,
    ...
    def convert_tokens_to_instance_2docs(self, tokens, labels:List[str] = None):
        premise = []
        query = []
        for l in labels:
            premise.append(Instance({
                "document": TextField(tokens, self._token_indexers),
                }))
            query.append(Instance({
                "document": TextField([Token(l)], self._token_indexers),
                }))

...
from experiment_3.baseline_models.classifiers.base_model import RationaleBaseModel
...
@Model.register("objective_2docs_model_cose")
class Objective2DocsModel(RationaleBaseModel):
    def __init__(
        self,
        vocab: Vocabulary,

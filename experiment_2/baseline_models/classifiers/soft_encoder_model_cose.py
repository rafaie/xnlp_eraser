...
from experiment_2.baseline_models.classifiers.base_model import RationaleBaseModel
from allennlp.modules import Seq2SeqEncoder, TextFieldEmbedder, FeedForward
from allennlp.modules.attention import Attention
from experiment_2.saliency_scorer.base_saliency_scorer import SaliencyScorer
...
class SoftEncoderRationaleModel(RationaleBaseModel):
    ...
    def generate_tokens(self, new_tokens, metadata, labels):
        ...
        return {"bert": {k: v.to(self._vector.device) for k, v in batch["document"]["bert"].items()}}

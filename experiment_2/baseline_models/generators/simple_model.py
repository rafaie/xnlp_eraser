...
class SimpleGeneratorModel(Model):
    ...
    def forward(self, document, rationale=None) -> Dict[str, Any]:
        ...
        average_rationale_length = util.masked_mean(output_dict['predicted_rationale'], mask.bool(), dim=-1).mean()
        ...
        if rationale is not None :
            ...
            self._rationale_f1_metric(predictions=class_probs, gold_labels=rationale, mask=mask.bool())
